  ...
  return (
    <div data-dial-init className="fixed bottom-6 right-24 group">
      <div
        ...
        className="flex flex-col justify-end hidden py-1 mb-4 space-y-2 bg-white border border-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600"
      >
